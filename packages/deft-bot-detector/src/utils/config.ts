...
const globalConfig = {
  ...
  production: {
    ...
    contract: {
      ...
      deftStorage: DEFT_STORAGE_PROD!,
      deftToken: DEFT_TOKEN_PROD!,
      deftTokenStartBlock: DEFT_TOKEN_START_BLOCK_PROD!,
  ...
  development: {
    ...
    contract: {
      ...
      deftStorage: DEFT_STORAGE_DEV!,
      deftToken: DEFT_TOKEN_DEV!,
      deftTokenStartBlock: DEFT_TOKEN_START_BLOCK_DEV!,
